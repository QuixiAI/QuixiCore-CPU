...
|---|---|---|---|---|---|---:|---|---|---|
| 2026-07-07 | quant_gemv (`dotprod`, 8 threads) | q8_0 | quant_matmul m=1 N4096 K4096 | Apple M4 Max, 8 threads, NEON DotProd | `scripts/bench --preset quick --kernel qgemv --threads 8` | 0.0679 ms | CV 0.024 | `perf/results/2026-07-07/030745-quick/` | 263 W-GB/s ~= aggregate DRAM roofline; in-progress |
