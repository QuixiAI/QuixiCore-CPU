...
// the combined weight*activation fp16 scales, in f32. y [N] = dequant(W) . x.
//
// Unlike qgemv (full-precision activations, the family contract), this op
// quantizes the activations — bounded extra error inside the umbrella
// `quantized` tolerance tier, but not bitwise-identical to the f32-activation
// path. Supported weight formats: kQ8_0 (8-bit) and kQ4_0 (4-bit); both use
// per-block int8 activations.
...
// Name of the resolved variant for the given weight format ("ref", "neon", ...).
